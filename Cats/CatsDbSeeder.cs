...
{
    private readonly Coat[] _expectedCoats =
    [
    ...
    private readonly Personality[] _expectedPersonalities =
    [
    ...
    private readonly Breed[] _expectedCats = 
    [
    ...
    private readonly Dictionary<Guid, List<Guid>> _expectedCatCoats = new()
    {
        { Guid.Parse("018f84d0-8c05-7a52-81e9-9c35e1d8b1b2"),       // Maine Coon: long, thick, water-repellent
            [
                Guid.Parse("019678de-dfef-70fa-8afb-ef0ac157c056"), 
                Guid.Parse("019678de-f495-784a-a631-7edcf72bf38f"),
                Guid.Parse("019678df-04cd-7c29-86da-8cac1f7b5ed2")
            ]
        },
        { Guid.Parse("018f84d0-8c05-7a53-8a1e-84748c6a69a0"),       // Siamese: short, fine, sleek
            [
                Guid.Parse("019678df-0f35-7c30-86c9-6a89a1e797bd"), 
                Guid.Parse("019678df-18aa-7b7a-b861-4a2c75ef6881"),
                Guid.Parse("019678df-275c-778d-85e6-fb03065e6c89")
            ]
        },
        { Guid.Parse("018f84d0-8c05-7a54-9d28-8c1ab7ee034d"),       // British Shorthair: short, dense, plush
            [
                Guid.Parse("019678df-0f35-7c30-86c9-6a89a1e797bd"), 
                Guid.Parse("019678df-3426-7962-999e-f0bb59962915"),
                Guid.Parse("019678df-42ce-7615-9aae-046d5164d7e4")
            ]
        },
        { Guid.Parse("018f84d0-8c05-7a55-8c94-9ba0a74b8a27"),       // Bengal: short, soft, glittered
            [
                Guid.Parse("019678df-0f35-7c30-86c9-6a89a1e797bd"), 
                Guid.Parse("019678df-5101-7052-a08f-0d881dd9b591"),
                Guid.Parse("019678df-5c8c-7b83-8de5-922df1b2cb00")
            ]
        },
        { Guid.Parse("018f84d0-8c05-7a56-9795-b20cf77a5e48"),       // Ragdoll: semi-long, silky
            [
                Guid.Parse("019678df-79d3-74e2-bfe1-c7e1bc7add75"), 
                Guid.Parse("019678df-6ae7-7487-9ecf-73ee03656bba")
            ]
        },
        { Guid.Parse("018f84d0-8c05-7a57-89be-b760f8ea5e4d"), 
            [
                Guid.Parse("019678df-8613-765a-8281-5d9b9e302175")
            ] }, // Sphynx: hairless
        { Guid.Parse("018f84d0-8c05-7a58-9b0a-b2cc7f9e6893"),       // Scottish Fold: short, dense
            [
                Guid.Parse("019678df-0f35-7c30-86c9-6a89a1e797bd"), 
                Guid.Parse("019678df-3426-7962-999e-f0bb59962915")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a59-93fe-99b43a9edc12"),       // Norwegian Forest Cat: long, thick
            [
                Guid.Parse("019678de-dfef-70fa-8afb-ef0ac157c056"), 
                Guid.Parse("019678de-f495-784a-a631-7edcf72bf38f")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a5a-978d-87e4af1d7b51"),       // Abyssinian: short, ticked
            [
                Guid.Parse("019678df-0f35-7c30-86c9-6a89a1e797bd"), 
                Guid.Parse("019678df-91ae-727b-8ac1-b63d5b58bef9")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a5b-92b1-b72cfc416edd"),       // Persian: long, luxurious
            [
                Guid.Parse("019678de-dfef-70fa-8afb-ef0ac157c056"), 
                Guid.Parse("019678df-9eeb-7b7b-a178-4b897e1d1c9f")
            ]
        }, 
    };

    private readonly Dictionary<Guid, List<Guid>> _expectedCatPersonalities = new()
    {
        { Guid.Parse("018f84d0-8c05-7a52-81e9-9c35e1d8b1b2"),       // Maine Coon: gentle, playful, intelligent
            [
                Guid.Parse("018f84c6-8c04-7a3d-a5f2-8b41cc556b5e"), 
                Guid.Parse("018f84c6-8c04-7a3e-bd9a-84989ee96eab"),
                Guid.Parse("018f84c6-8c04-7a3f-9910-9dfeb7cd2ae0")
            ]
        },
        { Guid.Parse("018f84d0-8c05-7a53-8a1e-84748c6a69a0"),       // Siamese: vocal, social, affectionate
            [
                Guid.Parse("018f84c6-8c04-7a40-9df5-9a7d1e4fd5a6"), 
                Guid.Parse("018f84c6-8c04-7a41-891a-ae1d5095b612"),
                Guid.Parse("018f84c6-8c04-7a42-8434-83e8ea51c2b5")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a54-9d28-8c1ab7ee034d"),       // British Shorthair: calm, easygoing, independent
            [
                Guid.Parse("018f84c6-8c04-7a43-8ab6-806fd0637b5e"), 
                Guid.Parse("018f84c6-8c04-7a44-bef1-8009487e23cc"),
                Guid.Parse("018f84c6-8c04-7a45-9633-8cd62f0f6c97")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a55-8c94-9ba0a74b8a27"),       // Bengal: energetic, curious, confident
            [
                Guid.Parse("018f84c6-8c04-7a46-9337-b457adddc839"), 
                Guid.Parse("018f84c6-8c04-7a47-9fe8-a8b129d779d3"),
                Guid.Parse("018f84c6-8c04-7a48-85ae-8acb83abeb07")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a56-9795-b20cf77a5e48"),       // Ragdoll: gentle, relaxed, affectionate
            [
                Guid.Parse("018f84c6-8c04-7a3d-a5f2-8b41cc556b5e"), 
                Guid.Parse("018f84c6-8c04-7a49-b858-bc6ef63a94bd"),
                Guid.Parse("018f84c6-8c04-7a42-8434-83e8ea51c2b5")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a57-89be-b760f8ea5e4d"),       // Sphynx: friendly, lively, mischievous
            [
                Guid.Parse("018f84c6-8c04-7a4a-8734-8c0a984fc358"), 
                Guid.Parse("018f84c6-8c04-7a4b-9ecf-85ea3b8bc903"),
                Guid.Parse("018f84c6-8c04-7a4c-89d8-8dbacc95e0e6")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a58-9b0a-b2cc7f9e6893"),       // Scottish Fold: sweet, adaptable, playful
            [
                Guid.Parse("018f84c6-8c04-7a4d-91f3-b25f39cf0638"), 
                Guid.Parse("018f84c6-8c04-7a4e-93e5-84cf623780f0"),
                Guid.Parse("018f84c6-8c04-7a3e-bd9a-84989ee96eab")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a59-93fe-99b43a9edc12"),       // Norwegian Forest Cat: independent, gentle, strong climber
            [
                Guid.Parse("018f84c6-8c04-7a45-9633-8cd62f0f6c97"), 
                Guid.Parse("018f84c6-8c04-7a3d-a5f2-8b41cc556b5e"),
                Guid.Parse("018f84c6-8c04-7a4f-8b4f-9e5f8d9e6f7e")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a5a-978d-87e4af1d7b51"),       // Abyssinian: curious, adventurous, affectionate
            [
                Guid.Parse("018f84c6-8c04-7a47-9fe8-a8b129d779d3"), 
                Guid.Parse("018f84c6-8c04-7a50-9937-95cfa95761d8"),
                Guid.Parse("018f84c6-8c04-7a42-8434-83e8ea51c2b5")
            ]
        }, 
        { Guid.Parse("018f84d0-8c05-7a5b-92b1-b72cfc416edd"),       // Persian: calm, affectionate, quiet
            [
                Guid.Parse("018f84c6-8c04-7a43-8ab6-806fd0637b5e"), 
                Guid.Parse("018f84c6-8c04-7a42-8434-83e8ea51c2b5"),
                Guid.Parse("018f84c6-8c04-7a51-8712-92a8f740ce3b")
            ]
        }, 
    };
    ...
    {
        var coats = Seed(dbContext, dbContext.Coats, _expectedCoats);
        
        var personalities = Seed(dbContext, dbContext.Personalities, _expectedPersonalities);
        
        var cats = Seed(dbContext, dbContext.Breeds.Include(c => c.Coats).Include(c => c.Personalities), _expectedCats);

        foreach (var cat in cats)
        {
            var expectedCoatsForCat = _expectedCatCoats[cat.Id];
            ...
            var expectedPersonalitiesForCat = _expectedCatPersonalities[cat.Id];
    ...
    private static List<TEntity> Seed<TEntity>(DbContext dbContext, IQueryable<TEntity> query, IEnumerable<TEntity> expectedEntities)
    ...
    {
        var coats = await SeedAsync(dbContext, dbContext.Coats, _expectedCoats, ct);
        
        var personalities = await SeedAsync(dbContext, dbContext.Personalities, _expectedPersonalities, ct);
        
        var cats = await SeedAsync(dbContext, dbContext.Breeds.Include(c => c.Coats).Include(c => c.Personalities), _expectedCats, ct);

        foreach (var cat in cats)
        {
            var expectedCoats = _expectedCatCoats[cat.Id];
            ...
            var expectedPersonalities = _expectedCatPersonalities[cat.Id];
    ...
    private static async Task<List<TEntity>> SeedAsync<TEntity>(DbContext dbContext, IQueryable<TEntity> query, IEnumerable<TEntity> expectedEntities, CancellationToken ct)
        where TEntity : class, IIdentifiable
    {
